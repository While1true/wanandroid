...
class _HomePageState extends State<HomePage> {
    ...
    switch (_state) {
      ...
      case ShowState.CONTENT:
        return RefreshLayout(onRefresh: (isrefresh) {
          ...
          child:
          ListView.builder(
            itemCount: _banner == null ? _articals.length : _articals.length +
                1,
            ...
            return new Builder(
              builder: (BuildContext context) {
                return new Container(
                    ...
                    child:
                    GestureDetector(onTap:(){_bannerClick(banner.url,banner.title);},child: Stack(children: <Widget>[
                      new Container(
                      ...
                      Align(child: DecoratedBox(decoration: BoxDecoration(color: Color(0xAAffffff)), child: Text(banner.title),),
  ...
  void _bannerClick(String link,String title) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MyWebPage(link,title)));
